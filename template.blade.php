...
table, td { color: #000000; } @media (max-width: 480px) { #u_column_7 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 0px solid transparent !important; } #u_content_heading_10 .v-container-padding-padding { padding: 5px 10px 20px !important; } #u_content_heading_10 .v-text-align { text-align: center !important; } #u_content_menu_1 .v-padding { padding: 0px 9px 12px !important; } #u_content_heading_1 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_heading_1 .v-text-align { text-align: center !important; } #u_content_heading_2 .v-container-padding-padding { padding: 0px 10px !important; } #u_content_heading_2 .v-font-size { font-size: 24px !important; } #u_content_heading_2 .v-text-align { text-align: center !important; } #u_content_image_1 .v-container-padding-padding { padding: 10px !important; } #u_content_heading_4 .v-container-padding-padding { padding: 30px 10px 0px !important; } #u_content_heading_4 .v-text-align { text-align: center !important; } #u_content_text_2 .v-container-padding-padding { padding: 5px 10px 10px !important; } #u_content_text_2 .v-text-align { text-align: center !important; } #u_content_button_1 .v-text-align { text-align: center !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px 10px 50px !important; } #u_content_heading_3 .v-container-padding-padding { padding: 30px 10px 5px !important; } #u_content_heading_3 .v-text-align { text-align: center !important; } #u_content_text_1 .v-container-padding-padding { padding: 0px 10px 30px !important; } #u_content_text_1 .v-text-align { text-align: center !important; } #u_content_heading_5 .v-container-padding-padding { padding: 30px 10px 5px !important; } #u_content_heading_5 .v-text-align { text-align: center !important; } #u_content_text_3 .v-container-padding-padding { padding: 0px 10px 30px !important; } #u_content_text_3 .v-text-align { text-align: center !important; } #u_content_heading_6 .v-container-padding-padding { padding: 30px 20px 10px !important; } #u_content_heading_6 .v-text-align { text-align: center !important; } #u_content_text_4 .v-container-padding-padding { padding: 0px 20px 10px !important; } #u_content_text_4 .v-text-align { text-align: center !important; } #u_content_social_1 .v-container-padding-padding { padding: 10px 0px 10px 80px !important; } #u_content_heading_8 .v-container-padding-padding { padding: 15px 10px 10px !important; } #u_content_heading_8 .v-text-align { text-align: center !important; } #u_content_heading_9 .v-container-padding-padding { padding: 5px 10px 20px !important; } #u_content_heading_9 .v-text-align { text-align: center !important; } }
    </style>
<!--[if !mso]><!--><link href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_a47c50ad.css') }}" rel="stylesheet" type="text/css"/><link href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_ce19f129.css') }}" rel="stylesheet" type="text/css"/><link href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_2a33c59b.css') }}" rel="stylesheet" type="text/css"/><!--<![endif]-->
</head>
...
<a class="v-padding v-font-size" href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_9fc44c42.bin') }}" style="padding: 21px 15px 12px; display: inline-block; color: rgb(0, 0, 0); font-family: Montserrat, sans-serif; font-size: 14px; text-decoration: none; line-height: inherit;" target="_self">Home
    </a>
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td style="padding:21px 15px 12px"><![endif]-->
<a class="v-padding v-font-size" href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_9fc44c42.bin') }}" style="padding: 21px 15px 12px; display: inline-block; color: rgb(0, 0, 0); font-family: Montserrat, sans-serif; font-size: 14px; text-decoration: none; line-height: inherit;" target="_self">Page
    </a>
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td style="padding:21px 15px 12px"><![endif]-->
<a class="v-padding v-font-size" href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_9fc44c42.bin') }}" style="padding: 21px 15px 12px; display: inline-block; color: rgb(0, 0, 0); font-family: Montserrat, sans-serif; font-size: 14px; text-decoration: none; line-height: inherit;" target="_self">About Us
    </a>
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td style="padding:21px 15px 12px"><![endif]-->
<a class="v-padding v-font-size" href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_9fc44c42.bin') }}" style="padding: 21px 15px 12px; display: inline-block; color: rgb(0, 0, 0); font-family: Montserrat, sans-serif; font-size: 14px; text-decoration: none; line-height: inherit;" target="_self">Contact Us
    </a>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 10px 0px 20px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Epilogue; font-size: 18px; font-weight: 400;"><span><span><span><span><span><span><span>Let’s Create</span></span></span></span></span></span></span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px 20px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Epilogue; font-size: 26px; font-weight: 400;"><span><span><span><span><span><strong>Something Amazing</strong></span></span></span></span></span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<img align="center" alt="image" border="0" src="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/1722205832705-3d-rendering-people-avatars-zoom-call_201.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 560px;" title="image" width="560"/>
</td>
</tr>
</table>
</td>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 5px 20px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Epilogue; font-size: 22px; font-weight: 400;"><span>Dear [Recipient Name], We are reaching out with an exciting opportunity for a potential partnership that would bring value to both our organizations.</span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<p style="line-height: 140%; margin: 0px;">We are reaching out to explore potential collaborations and partnerships in the technology sector. Our innovative solutions could bring mutual benefits.</p>
</div>
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 50px 20px;font-family:'Raleway',sans-serif;">
<!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
<div align="left" class="v-text-align">
<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_2f8c5a96.bin') }}" style="height:37px; v-text-anchor:middle; width:167px;" arcsize="11%"  stroke="f" fillcolor="#8c7bc8"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
<a class="v-button v-font-size" href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_2f8c5a96.bin') }}" style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(255, 255, 255); background: rgb(140, 123, 200); border-radius: 4px; width: auto; max-width: 100%; word-break: break-word; overflow-wrap: break-word; font-size: 14px; line-height: inherit;" target="_blank"><span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Collaborate with Us</span></span>
</a>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 5px 20px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Epilogue; font-size: 22px; font-weight: 400;"><span>Dear [Recipient Name], We are a leading content creation agency specializing in the technology sector. We believe that our unique approach to storytelling could greatly benefit your brand and help you connect with your audience more effectively.</span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px 30px 20px;font-family:'Raleway',sans-serif;">
<div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
<p style="line-height: 140%; margin: 0px;">Dear [Recipient's Name], we are reaching out to explore potential collaborations within the technology sector. Our company is dedicated to innovation and growth, and we believe that partnering with you could lead to mutually beneficial results.</p>
</div>
</td>
</tr>
</tbody>
...
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 5px 20px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Epilogue; font-size: 22px; font-weight: 400;"><span>Dear [Recipient's Name], We are excited to connect and explore potential collaborations within the technology industry.</span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px 30px 20px;font-family:'Raleway',sans-serif;">
<div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
<p style="line-height: 140%; margin: 0px;">Dear [Recipient], We are a forward-thinking technology company and we believe our services could complement your business. Let's explore collaboration opportunities within the Technology sector.</p>
</div>
</td>
</tr>
</tbody>
...
<p style="line-height: 170%; margin: 0px;">Dear [Recipient Name], We are reaching out to explore potential collaboration opportunities in the technology sector.</p>
</div>
</td>
</tr>
</tbody>
...
<a href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_0c984410.bin') }}" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;" target="_blank" title="Facebook"><img alt="Facebook" src="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/facebook.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Facebook" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<table border="0" cellpadding="0" cellspacing="0" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px" width="32">
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="https://www.linkedin.com/company/laravelmail/mycompany/" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;" target="_blank" title="LinkedIn"><img alt="LinkedIn" src="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/linkedin.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="LinkedIn" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<table border="0" cellpadding="0" cellspacing="0" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px" width="32">
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_9fd8adc6.bin') }}" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;" target="_blank" title="Instagram"><img alt="Instagram" src="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/instagram.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Instagram" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/asset_de62a5c7.bin') }}" style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;" target="_blank" title="X"><img alt="X" src="{{ asset('vendor/mail-templates/content-collaboration-outreach/assets/x.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="X" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
